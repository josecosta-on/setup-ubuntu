...
export JAVA_HOME
export ANDROID_HOME
PATH="$JAVA_HOME/bin:$ANDROID_HOME/cmdline-tools/tools/bin:$ANDROID_HOME/platform-tools:$ANDROID_HOME/buildtools:$PATH"' >> ~/.bashrc
...
sudo ln -s $ANDROID_HOME/build-tools/29.0.3 $ANDROID_HOME/buildtools
source ~/.bashrc
