...
# Install basics
RUN apt-get update &&  \
    apt-get install -y --force-yes git wget curl unzip build-essential && \
...
# install python-software-properties (so you can do add-apt-repository)
    apt-get update && apt-get install -y --force-yes -q python-software-properties software-properties-common  && \
